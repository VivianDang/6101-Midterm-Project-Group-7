...
summary(lm2)
```
As we can see from this summary, tenure has negative correlation with churn and monthlycharges has positive correlation with churn. It means when we have a customer with lower tenure and high monthlycharges having more probability to churn. 
