...
tenure_MonthlyCharges <- ggplot(data = customer, aes(x = MonthlyCharges, y = tenure, color = Churn)) + 
            geom_point(aes(fill = Churn), size = 2, alpha = 0.6) + 
             scale_fill_manual(values=c("pink3", "steelblue")) +
